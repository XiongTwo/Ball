...
public class PlayPopupOpener : PopupOpener
{
    ...
    public override void OpenPopup()
    {
        ...
        StartLevelInfo _StartLevelInfo = popup.GetComponent<StartLevelInfo>();
        if (_StartLevelInfo != null)
        {
            _StartLevelInfo.star = starsObtained;
            _StartLevelInfo.level=level;
            _StartLevelInfo.title.text += _StartLevelInfo.level.ToString();
        }
    }
}